...
def install(country=None):
	...
	# Mode of Payment
		{'doctype': 'Mode of Payment', 'mode_of_payment': 'Check' if country in {"United States", "Indonesia"} else _('Cheque'), 'type': 'Bank'},
		{'doctype': 'Mode of Payment', 'mode_of_payment': _('Cash'), 'type': 'Cash'},
		{'doctype': 'Mode of Payment', 'mode_of_payment': _('Credit Card'), 'type': 'Bank'},
		{'doctype': 'Mode of Payment', 'mode_of_payment': _('Debit Card'), 'type': 'Bank'},
...
def install_group_and_types(args=None):
	...
	# item group
		...
		{'doctype': 'Item Group', 'item_group_name': _('Raw Material'), 'is_group': 0, 'parent_item_group': _('All Item Groups') },
...
def install_territory(country=None):
	records = [
...
# Stock Settings:
	# account_settings.default_inventory_account = " - " + args.company_abbr
	# account_settings.stock_adjustment_account = " - " + args.company_abbr
...
# Fixed Assets Depreciation:
	...
	# account_settings.expenses_included_in_asset_valuation = " - " + args.company_abbr
	# account_settings.disposal_account = " - " + args.company_abbr
	# account_settings.capital_work_in_progress_account = " - " + args.company_abbr
	# account_settings.asset_received_but_not_billed = " - " + args.company_abbr
